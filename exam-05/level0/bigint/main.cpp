...
int main(void)
{
	...
	bigint xx(atoi("-999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999"));
	bigint yy(atoi("+999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999"));
	std::cout << "x < y " << (xx < yy) << std::endl;return (0);
}